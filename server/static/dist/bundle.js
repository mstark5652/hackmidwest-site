...
Object.defineProperty(exports, "__esModule", { value: true });
exports.content = {
    APP_TITLE: "Here Maps Api",
    INFO: "Info here.",
    ERROR: {
        CAMERA_ACCESS: "Oh snap! To run this app you will need to enable camera access in your browser address bar.",
        NETWORK: "No network connection found.",
        GENERIC: "An error occurred. Please try again later.",
        PLATFORM_UNSUPPPORTED: "Sorry. This platform is not supported.",
        SAFARI_WEBVIEW: "To run this app, please open directly into Safari."
    },
    ...
    LOCATION: {
        ...
        IWERX: { lat: 39.137278, lng: -94.579900 },
        KLAMM: { lat: 39.1337107, lng: -94.6594942 },
        OTHER: { lat: 39.140023, lng: -94.654708 },
        NEW: { lat: 39.135174, lng: -94.575763 },
        BBQ: { lat: 39.131004, lng: -94.577793 }
    },
    SOCKET_CONNECTION: "Socket Connected",
    INITIAL_MESSAGES: [
        {
            "id": "1",
            "message": "Michael just joined The Neighborhood!",
            "added": false
        }
    ]
};
...
let ZOOM = 14.5;
class HereMap {
    constructor(container, apiKey, appId, center) {
    ...
    addMarker(imageSrc, coords, focus = false) {
    ...
    route(start, destination) {
        ...
        router.calculateRoute(routingParameters, callback, function (error) {
...
class StateManager {
    ...
    loadBlank() {
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.CLEAN + "\')";
    ...
    loadDStart() {
        ...
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.frank + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.frankDwayne.accept + "\')";
        this.lg_map();
    ...
    loadDSec() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.frank + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.frankDwayne.perform + "\')";
        this.lg_map();
        // directions
    ...
    loadDThird() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.dwayne + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.frankDwayne.tipping + "\')";
        this.sm_map();
    ...
    loadDFour() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.CLEAN + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.frankDwayne.console + "\')";
        this.no_map();
    }
    // evelyn states
    loadEStart() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.matt + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.mattEvelyn.accept + "\')";
        this.lg_map();
        let event = new CustomEvent("add-iwerx-marker");
        document.dispatchEvent(event);
    }
    loadESec() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.matt + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.mattEvelyn.perform + "\')";
        this.lg_map();
        let event = new CustomEvent("show-directions");
        document.dispatchEvent(event);
    }
    loadEThird() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.evelyn + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.mattEvelyn.tipping + "\')";
        this.sm_map();
        let event = new CustomEvent("resize-map-for-small");
        document.dispatchEvent(event);
    }
    loadEFour() {
        this.backDrop.style.backgroundColor = "transparent";
        this.nav.style.backgroundImage = "url(\'" + content_1.content.NAV.CLEAN + "\')";
        this.backDrop.style.backgroundImage = "url(\'" + content_1.content.mattEvelyn.console + "\')";
        this.no_map();
    }
    xlg_map() {
...
const styles = __webpack_require__(/*! ./sass/main */ "./src/sass/main.scss");
const VIEWS = {
    // BTN_INFO: "btn-info",
...
class Ui {
    constructor() {
        ...
        this.messages = [];
        this.startingCoords = content_1.content.LOCATION.IWERX;
        this.stateManager = new state_1.StateManager(this.navContainer, this.mapContainer, this.sideBarContainer);
    ...
    addEvents() {
        ...
        document.addEventListener("add-iwerx-marker", () => {
            _this.hereMap.addMarker(content_1.content.SVG.MARKER_BLUE, content_1.content.LOCATION.IWERX);
        });
        document.addEventListener("show-directions", () => {
            // _this.hereMap.
            if (_this.stateManager.value == 1) {
                // frank/dwayne directions
                _this.hereMap.route(content_1.content.LOCATION.IWERX, content_1.content.LOCATION.BBQ);
            }
            else if (_this.stateManager.value == 5) {
                // evelyn/matt directions
                _this.hereMap.route(content_1.content.LOCATION.IWERX, content_1.content.LOCATION.NEW);
            }
        });
    }
    // Socket
    connectSocket() {
        ...
        socket.on('marker', function (data) {
            ...
            _this.hereMap.addMarker(src, { lat: data.lat, lng: data.lng }, data.center);
        });
    ...
    addInitialMessages() {
        this.messages = content_1.content.INITIAL_MESSAGES;
    ...
    setupMap(paramState) {
        this.hereMap = new map_1.HereMap(this.mapContainer, content_1.content.HERE_KEY, content_1.content.HERE_ID, this.startingCoords);
        ...
        if (paramState == 0) {
            this.hereMap.addMarker(content_1.content.SVG.MARKER_BLUE, content_1.content.LOCATION.IWERX);
            this.hereMap.addMarker(content_1.content.SVG.MARKER_ORANGE, content_1.content.LOCATION.BBQ);
        }
        else if (paramState == 4) {
            this.hereMap.addMarker(content_1.content.SVG.MARKER_BLUE, content_1.content.LOCATION.IWERX);
            this.hereMap.addMarker(content_1.content.SVG.MARKER_AQUA, content_1.content.LOCATION.NEW);
        }
    }
}
exports.ui = new Ui();
